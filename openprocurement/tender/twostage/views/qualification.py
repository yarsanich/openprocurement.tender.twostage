...
from openprocurement.tender.twostage.validation import validate_patch_qualification_data
from openprocurement.tender.twostage.utils import qualifications_resource, prepare_qualifications


@qualifications_resource(
    name='Tender Two Stage Qualification',
    ...
    description="Tender Two Stage Qualification")
class TenderQualificationResource(APIResource):
    ...
    def patch(self):
        ...
        if self.request.context.status == 'active':
            ...
            self.request.response.headers['Location'] = self.request.route_url('Tender Two Stage Qualification',
                                                                               tender_id=tender.id,
