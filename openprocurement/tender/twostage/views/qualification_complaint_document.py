# -*- coding: utf-8 -*-
from openprocurement.tender.twostage.views.award_complaint_document import TenderTSAwardComplaintDocumentResource
...
@qualifications_resource(
    name='Tender Two Stage Qualification Complaint Documents',
...
class TenderTSQualificationComplaintDocumentResource(TenderTSAwardComplaintDocumentResource):
